...
struct AttentionLayerPlan {
    ...
    explicit AttentionLayerPlan(const AttentionLayerBuffers &b) : scalars(b.scalars), forwards(b.paired ? 2 : 1) {
        ...
        if (b.tokens <= 0 || b.tokens % 16 || b.documents <= 0 || b.window < 0 ||
            ...
            !std::isfinite(b.attention_scale) || b.attention_scale <= 0)
        ...
        product(b.x, b.weight, b.projected, t, b.paired ? qk : features, m, m, 1, m, 1);
        if (b.paired)
        ...
        bf16_ops = {
            {b.post_y, b.output_weight, nullptr, b.output, b.bf16_raw[0], t, m, v, v, 1, v, 1},
            {b.dy, b.output_weight, nullptr, b.dpost, b.bf16_raw[1], t, v, m, m, 1, 1, v},
            {b.dy, b.post_y, nullptr, b.dw_o_unscaled, b.bf16_raw[2], m, v, t, 1, m, 1, v}
        };
        qkv = {b.projected, b.paired ? b.projected_v : b.projected + qk,
               ...
               b.paired ? qk : features, b.paired ? v : features, 128,
        ...
        for (int i = 0; i < forwards; ++i) matrix_tasks(i, false);
        finish();
    ...
    AttentionLayerSetup setup(Matmul *matrices, BF16Matmul *bf16_matrices, QKVTransform *transform) const {
        return {scalars, matrices, bf16_matrices, transform, forwards};
    }
};
